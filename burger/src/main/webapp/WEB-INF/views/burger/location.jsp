...
<script type="text/javascript">
	...
	const branch = [		
		...
		{brnach_no: '${Branch.branch_no}', branch_name: '${Branch.branch_name}', branch_addr: '${Branch.branch_address}'},
		</c:forEach>
	];
</script>
<style type="text/css">
...
<c:import url="/WEB-INF/views/template/header.jsp"></c:import>
	<div style="text-align: center;">
		<p style="margin: 0; font-size: 25px; padding: 5px;">근처 BGMG 찾기</p>		
	</div>
	<div class="map_wrap">
	...
	<script src="${path}/resources/js/locationMapJs.js"></script>
