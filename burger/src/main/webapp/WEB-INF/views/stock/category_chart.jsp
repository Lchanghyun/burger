			...
			<div class="category_wrapper">
				<c:choose>
					<c:when test="${category eq '채소류'}">
						<a href="category_chart?category=채소류" class="category_link select_category">채소류</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					<c:when test="${category eq '육류'}">
						<a href="category_chart?category=육류" class="category_link select_category">육류</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					<c:when test="${category eq '제과류'}">
						<a href="category_chart?category=제과류" class="category_link select_category">제과류</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					<c:when test="${category eq '음료'}">
						<a href="category_chart?category=음료" class="category_link select_category">음료</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					<c:when test="${category eq '소모품'}">
						<a href="category_chart?category=소모품" class="category_link select_category">소모품</a>
					</c:when>
					<c:otherwise>
