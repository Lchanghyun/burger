		...
		<div class="category_wrapper">
			<c:choose>
				<c:when test="${category eq '채소류'}">
					<a href="edit?category=채소류" class="category_link" style="font-weight: bold; font-size: 17px">채소류</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${category eq '육류'}">
					<a href="edit?category=육류" class="category_link" style="font-weight: bold; font-size: 16px">육류</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${category eq '제과류'}">
					<a href="edit?category=제과류" class="category_link" style="font-weight: bold; font-size: 16px">제과류</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${category eq '음료'}">
					<a href="edit?category=음료" class="category_link" style="font-weight: bold; font-size: 16px">음료</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${category eq '소모품'}">
					<a href="edit?category=소모품" class="category_link" style="font-weight: bold; font-size: 16px">소모품</a>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${category eq '단종'}">
					<a href="edit?category=단종" class="category_link" style="font-weight: bold; font-size: 16px">단종</a>
				</c:when>
				<c:otherwise>
